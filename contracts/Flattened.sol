...
// File contracts/HatSizeToken.sol
...
contract HatSizeToken is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    function increaseHouseLiquidity(
        uint256 amount
...
// File contracts/HatSizeGame.sol
...
contract HatSizeGame is AccessControl {
    ...
    function guessTheHatSize(
        ...
        if (numberToGuess == secretNumber) {
            ...
            require(
                hst.balanceOf(address(this)) < 100,
                "No Hat Size Tokens available! Please inform the admin"
            );
